...
RUN conda clean -ya
RUN pip install boto3 addict tqdm regex pyyaml opencv-python ruamel.yaml opencv-contrib-python nltk spacy future tensorboard wandb filelock tokenizers sentencepiece
# Set CUDA_ROOT
