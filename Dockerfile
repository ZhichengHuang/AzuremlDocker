...
RUN conda clean -ya
RUN pip install boto3 addict tqdm regex pyyaml opencv-python azureml-defaults=1.12 opencv-contrib-python nltk spacy future tensorboard wandb filelock tokenizers sentencepiece
# Set CUDA_ROOT
